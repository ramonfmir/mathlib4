...
The general approach is to formulate the theorem that you are interested and prove it, with the
...
variable (M N : Type u) (μ : M → N → N) (r s : N → N → Prop) (m : M) {a b c : N}
...
theorem lt_of_mul_lt_mul_left' [contravariant_class α α (. * .) (. < .)] :
  a * b < a * c → b < c :=
...
theorem mul_le_mul_left' (h : a ≤ b) (c) :
  c * a ≤ c * b :=
covariant_class.covc c h

-- @[to_additive]
theorem mul_lt_of_mul_lt_left (h : a * b < c) (hle : d ≤ b) :
  a * d < c :=
lt_of_le_of_lt (mul_le_mul_left' hle a) h

-- @[to_additive]
theorem mul_le_of_mul_le_left (h : a * b ≤ c) (hle : d ≤ b) :
  a * d ≤ c :=
le_trans (mul_le_mul_left' hle a) h

-- @[to_additive]
theorem lt_mul_of_lt_mul_left (h : a < b * c) (hle : c ≤ d) :
  a < b * d :=
lt_of_lt_of_le h (mul_le_mul_left' hle b)

-- @[to_additive]
theorem le_mul_of_le_mul_left (h : a ≤ b * c) (hle : c ≤ d) :
  a ≤ b * d :=
le_trans h (mul_le_mul_left' hle b)

end has_mul

-- here we start using properties of one.
-- section mul_one_class
-- variable [mul_one_class α] [covariant_class α α (. * .) (. ≤ .)]

-- @[to_additive le_add_of_nonneg_right]
-- theorem le_mul_of_one_le_right' (h : 1 ≤ b) : a ≤ a * b :=
-- by simpa only [mul_one] using mul_le_mul_left' h a

-- @[to_additive add_le_of_nonpos_right]
-- theorem mul_le_of_le_one_right' (h : b ≤ 1) : a * b ≤ a :=
-- by simpa only [mul_one] using mul_le_mul_left' h a
...
theorem lt_of_mul_lt_mul_right' [contravariant_class α α (Function.swap (. * .)) (. < .)]
  (h : a * b < c * b) :
  a < c :=
  sorry
...
theorem mul_le_mul_right' (h : a ≤ b) (c) :
  a * c ≤ b * c :=
sorry
-- covariant_class.covc c h

-- @[to_additive]
theorem mul_lt_of_mul_lt_right (h : a * b < c) (hle : d ≤ a) :
  d * b < c :=
lt_of_le_of_lt (mul_le_mul_right' hle b) h

-- @[to_additive]
theorem mul_le_of_mul_le_right (h : a * b ≤ c) (hle : d ≤ a) :
  d * b ≤ c :=
le_trans (mul_le_mul_right' hle b) h

-- @[to_additive]
theorem lt_mul_of_lt_mul_right (h : a < b * c) (hle : b ≤ d) :
  a < d * c :=
lt_of_lt_of_le h (mul_le_mul_right' hle c)

-- @[to_additive]
theorem le_mul_of_le_mul_right (h : a ≤ b * c) (hle : b ≤ d) :
  a ≤ d * c :=
le_trans h (mul_le_mul_right' hle c)
...
theorem lt_of_add_lt_add_right [contravariant_class α α (Function.swap (. + .)) (. < .)]
  (h : a + b < c + b) :
  a < c :=
  sorry
-- contravariant_class.covtc b h
...
theorem add_le_add_right (h : a ≤ b) (c) :
  a + c ≤ b + c :=
sorry
-- covariant_class.covc c h

theorem add_lt_of_add_lt_right (h : a + b < c) (hle : d ≤ a) :
  d + b < c :=
lt_of_le_of_lt (add_le_add_right hle b) h

theorem add_le_of_add_le_right (h : a + b ≤ c) (hle : d ≤ a) :
  d + b ≤ c :=
le_trans (add_le_add_right hle b) h

theorem lt_add_of_lt_add_right (h : a < b + c) (hle : b ≤ d) :
  a < d + c :=
lt_of_lt_of_le h (add_le_add_right hle c)

theorem le_add_of_le_add_right (h : a ≤ b + c) (hle : b ≤ d) :
  a ≤ d + c :=
le_trans h (add_le_add_right hle c)

end has_add

-- here we start using properties of one.
-- section mul_one_class
-- variable [mul_one_class α] [covariant_class α α (Function.swap (. * .)) (. ≤ .)]
...
-- @[to_additive]
-- theorem lt_mul_of_lt_of_one_le' (hbc : b < c) (ha : 1 ≤ a) :
--   b < c * a :=
-- hbc.trans_le $ le_mul_of_one_le_right' ha

-- @[to_additive]
-- theorem lt_mul_of_lt_of_one_lt' (hbc : b < c) (ha : 1 < a) :
--   b < c * a :=
...
-- variable [covariant_class α α (. * .) (. ≤ .)] [covariant_class α α (Function.swap (. * .)) (. ≤ .)]

-- @[to_additive]
-- theorem le_mul_of_one_le_of_le (ha : 1 ≤ a) (hbc : b ≤ c) : b ≤ a * c :=
...
-- @[to_additive]
-- theorem mul_le_of_le_one_of_le' (ha : a ≤ 1) (hbc : b ≤ c) : a * b ≤ c :=
-- one_mul c ▸ mul_le_mul' ha hbc

-- @[to_additive]
-- theorem mul_le_of_le_of_le_one' (hbc : b ≤ c) (ha : a ≤ 1) : b * a ≤ c :=
-- mul_one c ▸ mul_le_mul' hbc ha

-- @[to_additive]
-- theorem mul_lt_one_of_lt_one_of_le_one' (ha : a < 1) (hb : b ≤ 1) : a * b < 1 :=
-- (mul_le_of_le_of_le_one' le_rfl hb).trans_lt ha

-- @[to_additive]
-- theorem mul_lt_one_of_le_one_of_lt_one' (ha : a ≤ 1) (hb : b < 1) : a * b < 1 :=
-- (mul_le_of_le_one_of_le' ha le_rfl).trans_lt hb

-- @[to_additive]
-- theorem mul_lt_one' (ha : a < 1) (hb : b < 1) : a * b < 1 :=
-- mul_lt_one_of_le_one_of_lt_one' ha.le hb

-- @[to_additive]
-- theorem mul_lt_of_le_one_of_lt' (ha : a ≤ 1) (hbc : b < c) : a * b < c :=
-- lt_of_le_of_lt (mul_le_of_le_one_of_le' ha le_rfl) hbc

-- @[to_additive]
-- theorem mul_lt_of_lt_of_le_one' (hbc : b < c) (ha : a ≤ 1)  : b * a < c :=
-- lt_of_le_of_lt (mul_le_of_le_of_le_one' le_rfl ha) hbc

-- @[to_additive]
-- theorem mul_lt_of_lt_one_of_lt' (ha : a < 1) (hbc : b < c) : a * b < c :=
-- mul_lt_of_le_one_of_lt' ha.le hbc

-- @[to_additive]
-- theorem mul_lt_of_lt_of_lt_one' (hbc : b < c) (ha : a < 1) : b * a < c :=
...
-- variable [mul_one_class α] [partial_order α]
--   [covariant_class α α (. * .) (. ≤ .)] [covariant_class α α (Function.swap (. * .)) (. ≤ .)]
...
-- section mono
-- variable {β : Type*} [preorder β] {f g : β → α}

-- @[to_additive monotone.add]
-- theorem monotone.mul' (hf : monotone f) (hg : monotone g) : monotone (λ x, f x * g x) :=
-- λ x y h, mul_le_mul' (hf h) (hg h)

-- @[to_additive monotone.add_const]
-- theorem monotone.mul_const' (hf : monotone f) (a : α) : monotone (λ x, f x * a) :=
-- hf.mul' monotone_const

-- @[to_additive monotone.const_add]
-- theorem monotone.const_mul' (hf : monotone f) (a : α) : monotone (λ x, a * f x) :=
...
-- theorem le_of_mul_le_mul_left' [partial_order α] [left_cancel_semigroup α]
...
-- theorem le_of_mul_le_mul_right' [partial_order α] [right_cancel_semigroup α]
...
-- @[to_additive]
-- theorem mul_lt_mul_of_lt_of_le (h₁ : a < b) (h₂ : c ≤ d) : a * c < b * d :=
...
-- @[to_additive]
-- theorem lt_mul_of_one_lt_of_le (ha : 1 < a) (hbc : b ≤ c) : b < a * c :=
...
-- @[to_additive]
-- theorem mul_lt_of_lt_one_of_le (ha : a < 1) (hbc : b ≤ c) : a * b < c :=
...
-- @[to_additive]
-- theorem lt_mul_of_le_of_one_lt (hbc : b ≤ c) (ha : 1 < a) : b < c * a :=
-- mul_one b ▸ mul_lt_mul_of_le_of_lt hbc ha

-- @[to_additive]
-- theorem mul_lt_of_le_of_lt_one (hbc : b ≤ c) (ha : a < 1) : b * a < c :=
...
-- @[to_additive]
-- theorem mul_eq_one_iff_eq_one_of_one_le
